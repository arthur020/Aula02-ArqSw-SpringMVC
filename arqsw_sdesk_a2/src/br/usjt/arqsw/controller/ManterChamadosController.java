...
public class ManterChamadosController {
	...
	@RequestMapping("/verifica_usuario")
	public String VerificaUsuario(@Valid Usuario usuario, BindingResult result, HttpSession session, Model model) {

		try {
			boolean user = usuarioService.verificaUsuario(usuario);
			if (user == true) {
